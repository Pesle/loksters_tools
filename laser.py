#!/usr/bin/env python 
"""
Modified by Krasimir Stefanov 2017, lokiisyourmaster@gmail.com 
...
class laser_gcode(inkex.Effect):
    ...
    def export_gcode(self,gcode):
        ...
        f.write(
            ...
            "G1 X"+self.options.x_offset+" ; move to x offset\n" +
            "G1 Y"+self.options.y_offset+"; move to y offset\n" +
    ...
    def __init__(self):
        ...
        self.OptionParser.add_option("",   "--laser-command",                   action="store", type="string",          dest="laser_command",                       default="M106",                         help="Laser gcode command")
        self.OptionParser.add_option("",   "--laser-off-command",               action="store", type="string",          dest="laser_off_command",                   default="M107",                         help="Laser gcode end command")       
        self.OptionParser.add_option("",   "--laser-speed",                     action="store", type="int",             dest="laser_speed",                         default="30",                           help="Laser speed (mm/min)")
        self.OptionParser.add_option("",   "--travel-speed",                    action="store", type="string",          dest="travel_speed",                        default="6000",                         help="Travel speed (mm/min)")
...
################################################################################
    def orientation(self, layer=None) :
        ...
        print_("Document height: " + str(doc_height));
            ...
            #orientation_scale = 25.400000026
        ...
        for i in points :
            ...
            t = inkex.etree.SubElement(    g, inkex.addNS('text','svg'), 
                {
                    'style':    "font-size:5px;font-style:normal;font-variant:normal;font-weight:normal;font-stretch:normal;fill:#000000;fill-opacity:1;stroke:none;",
                    inkex.addNS("space","xml"):"preserve",
                    'x':    str(si[0]+10),
